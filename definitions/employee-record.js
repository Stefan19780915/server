...
docDefinition.content[1].table.body.push([{text: 'Dátum ukončenia:', bold:true,style: 'table'},{text: '', border: [false,false,false,true], style:'table'},{text:'',border:[false,false,false,true],style: 'table'},{text: contract.contractEndDate == 'indefinite' ? 'neurčito' : moment(contract.contractEndDate).format('LL') ,border: [false,false,true,true],style:'table'}]);
